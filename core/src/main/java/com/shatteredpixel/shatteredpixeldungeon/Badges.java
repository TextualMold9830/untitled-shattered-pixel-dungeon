...
public class Badges {
	...
	static {
		...
		firstBossClassBadges.put(HeroClass.POTIONMASTER, Badge.BOSS_SLAIN_1_POTIONMASTER);
	}
	...
	static {
		...
		victoryClassBadges.put(HeroClass.POTIONMASTER, Badge.VICTORY_POTIONMASTER);
	}
	...
	public static void validateMastery() {
		...
		case HUNTRESS:
			...
			break;
			case POTIONMASTER:
				badge = Badge.MASTERY_POTIONMASTER;
				break;
		}
